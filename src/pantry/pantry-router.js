...
PantryRouter
    ...
    .post(jsonParser, (req, res, next) => {
        const { user_id, item_name, category_1, category_2, category_3, category_4, category_5, category_6, category_7, quantity } = req.body
        const newItem = { user_id, item_name, category_1, category_2, category_3, category_4, category_5, category_6, category_7, quantity }
...
PantryRouter
    ...
    .patch(jsonParser, (req, res, next) => {
        const { user_id, item_name, category_1, category_2, category_3, category_4, category_5, category_6, category_7, quantity } = req.body
        const itemToUpdate = { user_id, item_name, category_1, category_2, category_3, category_4, category_5, category_6, category_7, quantity }
